...
namespace P2FixAnAppDotNetCode.Models.Repositories
{
    ...
    public class ProductRepository : IProductRepository
    {
        ...
        {
            // GRB : j'ai rajouté une routine qui ne genere
            // les produits qu'au démarrage de l'appli
            if (!_isInitialized)
            {
        ...
        private void GenerateProductData()
        {
            ...
            _products.Add(new Product(++id, 2, 9.99, "Anker 3ft / 0.9m Nylon Braided", "Tangle-Free Micro USB Cable"));
